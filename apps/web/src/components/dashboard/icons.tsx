...
const PATHS = {
  ...
  team: "M16 19v-1.5a3.5 3.5 0 0 0-3.5-3.5h-5A3.5 3.5 0 0 0 4 17.5V19M10 11a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zM20 19v-1.5a3.5 3.5 0 0 0-2.5-3.35M15.5 4.15a3.5 3.5 0 0 1 0 6.7",
  settings:
    "M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM19.4 13.5l1.6 1.2-2 3.5-1.9-.7a7.6 7.6 0 0 1-2.1 1.2L14.7 21h-4l-.3-2.3a7.6 7.6 0 0 1-2.1-1.2l-1.9.7-2-3.5 1.6-1.2a7.7 7.7 0 0 1 0-2.4L4.4 9.9l2-3.5 1.9.7a7.6 7.6 0 0 1 2.1-1.2L10.7 3h4l.3 2.3a7.6 7.6 0 0 1 2.1 1.2l1.9-.7 2 3.5-1.6 1.2a7.7 7.7 0 0 1 0 2.4z",
